...
import type { NormalizedContinuation, NormalizedRequest } from "./normalize.js";
...
function buildProjectRulesSection(rules: string[]): PromptSection {
	return {
		id: "project_rules",
		kind: "project_rules",
		content: [
...
function buildObjectiveSection(req: NormalizedRequest): PromptSection {
	return {
		id: "objective",
		kind: "objective",
		content: [
...
function buildAcceptanceCriteriaSection(req: NormalizedRequest): PromptSection {
	return {
...
function buildContextSection(req: NormalizedRequest): PromptSection {
...
function buildConstraintsSection(req: NormalizedRequest): PromptSection {
	return {
...
function buildFilesInScopeSection(req: NormalizedRequest): PromptSection {
	return {
		id: "files_in_scope",
		kind: "files_in_scope",
		content: [
...
function buildRequiredOutputSection(req: NormalizedRequest): PromptSection {
	return {
		id: "required_output",
...
function buildToolPermissionsSection(req: NormalizedRequest): PromptSection {
	return {
		id: "tool_permissions",
...
function buildContinuationSection(req: NormalizedRequest): PromptSection {
	const cont = req.continuation as NormalizedContinuation;
	const completedLines =
		cont.completedItems.length > 0
			? [
					"",
