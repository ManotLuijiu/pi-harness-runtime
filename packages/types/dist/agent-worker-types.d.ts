...
export type AgentStatus = "idle" | "initializing" | "running" | "paused" | "stopped" | "error";
 ...
 */
export declare class AgentWorkerRegistry {
    private factories;
    /**
...
//# sourceMappingURL=agent-worker-types.d.ts.map