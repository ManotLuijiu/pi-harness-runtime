 ...
 */
export type SemanticEvent = TaskAssigned | TaskStarted | TaskCompleted | TaskFailed | ReviewRequested | ReviewCompleted | ArchitectureDecision | CodeGenerated | TestsPassed | TestsFailed | HumanApprovalRequested | HumanApprovalGranted | WorkflowFinished;
