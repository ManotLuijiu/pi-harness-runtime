...
export type DivergenceReason = "source_file_changed" | "project_rules_changed" | "provider_output_differs" | "test_environment_changed" | "required_artifact_missing" | "runtime_version_differs";
...
export type ReplayRuntimeEvent = {
    ...
    type: "replay.state.reconstructed";
    jobId: string;
    sequence: number;
} | {
