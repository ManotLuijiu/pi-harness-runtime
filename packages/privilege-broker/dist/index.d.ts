 ...
 * ```
 */
export type { PrivilegeEntry, PrivilegeRegistry, CapabilityName, CapabilityGrant, AuditEntry, AuditLogger, ApprovalClass, } from "./types.js";
export { loadRegistry, type PrivilegeRegistryError } from "./registry.js";
export { type ApprovalResult, registerApprovalClass, checkApproval, clearApprovalCache, } from "./approval.js";
export { NoOpAuditLogger, ConsoleAuditLogger, FileAuditLogger, } from "./audit.js";
