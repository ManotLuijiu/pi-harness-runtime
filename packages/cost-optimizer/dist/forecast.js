 ...
 */
export function forecastCosts(requirements, options) {
    const byTaskType = {};
    let total = 0;
    const assumptions = [];
    for (const req of requirements) {
        ...
        const estimated = (req.estimatedInputTokens + req.estimatedOutputTokens) * avgCostPerToken;
 ...
 */
export function quickForecast(inputTokens, outputTokens) {
