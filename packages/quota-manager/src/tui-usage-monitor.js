...
export class TUIUsageMonitor extends EventEmitter {
     ...
     */
    containsExhaustedKeywords(message) {
        const keywords = [
            "exhausted",
            "quota",
            "limit",
 ...
 */
export function createTUIUsageMonitor(quotaManager, pi, config) {
