...
export type FrameworkCategory = "frappe" | "frappe_spa" | "nextjs" | "react" | "vite" | "django" | "laravel" | "express" | "fastapi" | "unknown";
...
export type PackageManagerType = "npm" | "yarn" | "pnpm" | "bun" | "pip" | "poetry" | "bench";
...
export type TestRunner = "vitest" | "jest" | "pytest" | "playwright" | "cypress" | "bun_test" | "bench_test" | "phpunit" | "unknown";
...
export type WarningCode = "CONFLICTING_FRAMEWORKS" | "MULTIPLE_PACKAGE_MANAGERS" | "NO_TEST_CONFIG" | "NO_FRAMEWORK_DETECTED" | "MISSING_RULES" | "UNKNOWN_LANGUAGE";
...
export interface FrameworkAnalyzerPlugin {
     ...
     */
    analyze(root: string, detection: DetectionResult, fs: ReadonlyFileSystem): Promise<Partial<ProjectProfile>>;
}
...
export type AnalysisErrorCode = "REPOSITORY_NOT_FOUND" | "NOT_A_DIRECTORY" | "SYMLINK_ESCAPE" | "SCAN_LIMIT_EXCEEDED" | "INVALID_CONFIG" | "UNKNOWN_ERROR";
