...
import { DEFAULT_TASK_COMPILER_CONFIG, PROVIDER_HINTS, TaskCompilerError, TaskCompilerErrorCode, } from "./types.js";
import { assertEveryCriterionAssigned, assertEveryTaskHasVerification, assertNoCycles, assertNoEmptyObjectives, assertNoExclusiveFileOverlap, } from "./validate.js";
 ...
 */
export async function compileTasks(input, config) {
    const fullConfig = {
