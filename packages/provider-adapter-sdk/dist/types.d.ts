...
export interface ProviderAdapter {
    ...
    complete: (prompt: string, options?: Record<string, unknown>) => Promise<ProviderResponse>;
    streaming?: (prompt: string, options?: Record<string, unknown>) => AsyncGenerator<StreamEvent>;
