 ...
 */
export function createClipboardBridgeTool() {
    return {
        capability: "tool",
 ...
 */
export function createClipboardBridgePlugin() {
    return {
 ...
 */
export function registerPasteShortcutHandler(pi, Key) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    registerPasteShortcut(pi, Key);
}
/**
