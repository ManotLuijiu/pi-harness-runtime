 ...
 */
import { mkdirSync, openSync, writeSync, fsyncSync, closeSync, renameSync, chmodSync, } from "node:fs";
 ...
 */
export function atomicWriteFileSync(finalPath, content) {
 ...
 * override it.
 */
export function defaultCachePathFor(provider) {
