...
/** Raw row as parsed from a Netscape file. */
interface NetscapeRow {
	domain: string;
	path: string;
	secure: boolean;
	httpOnly: boolean;
 ...
 */
export function parseNetscape(text: string): CanonicalCookie[] {
 ...
 */
export function serializeNetscape(cookies: CanonicalCookie[]): string {
