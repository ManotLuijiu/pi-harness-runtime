...
export interface SyncResult {
	...
	skippedFiles: Array<{ basename: string; reason: string }>;
	...
	errors: Array<{ basename: string; message: string }>;
}
...
export type WatcherEvent =
	...
	| { kind: "sync-skip"; reason: string }
	| { kind: "sync-error"; message: string }
	| { kind: "watcher-error"; message: string };
