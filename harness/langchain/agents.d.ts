...
export declare function createPlannerAgent(
    opts?: ModelOptions,
): import("langchain").ReactAgent<
    import("langchain").AgentTypeConfig<
        import("langchain").ResponseFormatUndefined,
        undefined,
        import("langchain").AnyAnnotationRoot,
        readonly import("langchain").AnyAgentMiddleware[],
        readonly [],
        readonly []
    >
>;
export declare function createCoderAgent(
    opts?: ModelOptions,
): import("langchain").ReactAgent<
    import("langchain").AgentTypeConfig<
        import("langchain").ResponseFormatUndefined,
    ...
    >
>;
export declare function createReviewerAgent(
    opts?: ModelOptions,
): import("langchain").ReactAgent<
    import("langchain").AgentTypeConfig<
        {
...
export declare function buildDelegationTools(opts?: {
    ...
    delegateToCoder: import("langchain").DynamicStructuredTool<
        z.ZodObject<
            {
        ...
        "delegate_to_coder"
    >;
    delegateToReviewer: import("langchain").DynamicStructuredTool<
        z.ZodObject<
            {
                plan: z.ZodString;
                code: z.ZodString;
