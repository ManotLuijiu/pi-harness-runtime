...
declare const LoopState: import("@langchain/langgraph").AnnotationRoot<{
    ...
    iteration: import("@langchain/langgraph").BaseChannel<
        number,
    ...
    log: import("@langchain/langgraph").BaseChannel<
        string[],
        string[] | import("@langchain/langgraph").OverwriteValue<string[]>,
        unknown
    >;
    /** Code from the previous iteration. Used for stuck detection (P0-2). */
    prevCode: import("@langchain/langgraph").BaseChannel<
        string | undefined,
        | string
    ...
    writtenFiles: import("@langchain/langgraph").BaseChannel<
        Record<string, string>,
        | import("@langchain/langgraph").OverwriteValue<Record<string, string>>
        | Record<string, string>,
        unknown
    >;
}>;
...
export declare function buildWriteReviewLoop(
    deps: LoopDeps,
    opts?: {
 ...
 */
export declare function buildRealLoopDeps(
