...
declare const LoopState: import("@langchain/langgraph").AnnotationRoot<{
    ...
    prevCode: import("@langchain/langgraph").BaseChannel<string | undefined, string | import("@langchain/langgraph").OverwriteValue<string | undefined> | undefined, unknown>;
    ...
    writtenFiles: import("@langchain/langgraph").BaseChannel<Record<string, string>, import("@langchain/langgraph").OverwriteValue<Record<string, string>> | Record<string, string>, unknown>;
}>;
...
export declare function buildWriteReviewLoop(deps: LoopDeps, opts?: {
    ...
    prevCode?: string | import("@langchain/langgraph").OverwriteValue<string | undefined> | undefined;
    writtenFiles?: import("@langchain/langgraph").OverwriteValue<Record<string, string>> | Record<string, string> | undefined;
