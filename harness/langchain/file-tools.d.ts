 ...
 */
export declare const readFile: import("langchain").DynamicStructuredTool<
   z.ZodObject<
      {
         path: z.ZodString;
 ...
 */
export declare const writeFile: import("langchain").DynamicStructuredTool<
   z.ZodObject<
      {
         path: z.ZodString;
         content: z.ZodString;
 ...
 */
export declare const listDir: import("langchain").DynamicStructuredTool<
   z.ZodObject<
      {
         path: z.ZodString;
      },
