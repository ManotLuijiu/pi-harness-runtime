 ...
 */
export class ZaiBrowserScraper extends BaseBrowserScraper {
    cookiesFile;
    constructor(config = {}) {
        super({
            provider: "z-ai",
 ...
 */
export async function scrapeZaiQuota(cookiesFile) {
 ...
 */
export function checkZaiCookies() {
    for (const location of COOKIE_LOCATIONS) {
        if (existsSync(location)) {
...
//# sourceMappingURL=zai-browser-scraper.js.map